...
// ----------------------------------------------------------------------
// Middleware: requireAuth (with store_id + active_store_id fix)
// ----------------------------------------------------------------------
...
router.post('/setup', async (req, res) => {
  try {
    ...
    res.status(201).json({
      ...
      token,
      user: {
        id: newUser.id, name, email, role: 'super_admin', avatar, status: 'active',
...
// ----------------------------------------------------------------------
// Exports: router (default) + middleware (named)
// ----------------------------------------------------------------------
